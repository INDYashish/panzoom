		...
		setMatrix: function(matrix, options) {
			...
			if (contain) {
				...
				if (contain === 'invert') {
					...
					diffW = width - container.width;// width > container.width ? width - container.width : //here we make change --NEWCHANGE
					diffH = height - container.height;//height > container.height ? height - container.height :

					//console.log(diffW,diffH,width , container.width);
